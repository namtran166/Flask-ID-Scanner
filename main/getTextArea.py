...
def set_FLAGS(path):
    tf.app.flags.DEFINE_string('test_data_path', 'data/demo/' + path + '/', '')
    tf.app.flags.DEFINE_string('output_path', 'data/res/' + path + '/', '')
